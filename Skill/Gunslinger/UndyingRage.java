...
public class UndyingRage extends Skill {
	...
	private static final double MANA_COST = 5, COOLDOWN = 6000, HEAL_PERCENT = 10;
	...
	public String getInfo() {
		return String.format("Undying Rage: Restores %.1f % of the player's health", HEAL_PERCENT);
	}
